...
do
    ...
    if ((e == 2)); then
        ...
        sed -i "s/# replicaof <masterip> <masterport>/replicaof 172.28.171.3 35${i}/g" /usr/local/redis/bin/redis_35${i}.conf
        sed -i "s/172.28.170.202/172.28.171.7/g" /usr/local/redis/bin/redis_35${i}.conf
